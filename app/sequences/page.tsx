/**
 * Sequences List Page
 * Shows all email sequences with their status
 */
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Secuencias de Emails</h1>
            <p className="mt-2 text-sm text-gray-600">
              Gestiona secuencias automatizadas de emails con múltiples pasos
            </p>
          </div>
          <Link
            href="/sequences/new"
